...
public class AngelApplicationMaster extends CompositeService {
    ...
    public class RunningAppContext implements AMContext {
        ...
        @Override
        public KubernetesClusterManager getK8sClusterManager() {
            return null;
        }
        ...
        @Override
        public int getPSReplicationNum() {
        ...
        @Override
        public AMModelSaver getModelSaver() {
            return modelSaver;
        }

        @Override
        public AMModelLoader getModelLoader() {
            return modelLoader;
        }
    ...
    //angel app master shutdown hook ,use thread
