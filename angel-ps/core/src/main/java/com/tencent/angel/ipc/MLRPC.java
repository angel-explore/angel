...
public class MLRPC {
    ...
    public static RpcServer getServer(Class protocol,
        ...
        return getProtocolEngine(protocol, conf).getServer(protocol, instance, ifaces, bindAddress, port, conf);
    }
    ...
    private static synchronized RpcEngine getProtocolEngine(Class protocol, Configuration conf) {
        ...
        if (engine == null) {
            ...
            LOG.debug("getProtocolEngine Using " + impl.getName() + " for " + protocol.getName());
    ...
    public static VersionedProtocol getProxy(Class<? extends VersionedProtocol> protocol,
        ...
        VersionedProtocol proxy = engine.getProxy(protocol, clientVersion, addr, conf, factory, rpcTimeout, addrList4Failover);
        return proxy;
    }
    ...
    public static VersionedProtocol getProxy(Class<? extends VersionedProtocol> protocol,
        ...
        return getProxy(protocol, clientVersion, addr, conf, NetUtils.getDefaultSocketFactory(conf), rpcTimeout, addrList4Failover);
    }
