...
public abstract class AngelClient implements AngelClientInterface {
    ...
    protected void startHeartbeat() throws ServiceException {
        ...
        clientId = master.getClientId(null, GetClientIdRequest.getDefaultInstance()).getClientId();// rpc调用获取client id
        master.clientRegister(null, ClientRegisterRequest.newBuilder().setClientId(clientId).build());// master register client
